...
/*private*/
Gui::Gui(const std::string& dataFolderPath, gloost::Mouse* mouse):
  _guiElements(),
  _mouse(mouse),
  _mouseIsExtern(0),
  _guiWidth(3000),
...
Gui::frameStep()
{
  ...
  if (_enabled)
  {
    ...
    /// this will hapen
    if (_mouse->getMouseUpEvent(GLOOST_MOUSE_BUTTON1) && !getWidgetByMousePosition())
    {
...
//		if (state == GLUT_DOWN)
//		{
//			getMouse()->setButtonState(GLOOST_MOUSE_BUTTON1, true);
//		}
//		else if (state == GLUT_UP)
//		{
//			getMouse()->setButtonState(GLOOST_MOUSE_BUTTON1, false);
//		}
//	}
...
//		if (state == GLUT_DOWN)
//		{
//			getMouse()->setButtonState(GLOOST_MOUSE_BUTTON2, true);
//		}
//		else
//		{
//			getMouse()->setButtonState(GLOOST_MOUSE_BUTTON2, false);
//		}
//	}
...
//		if (state == GLUT_DOWN)
//		{
//			getMouse()->setButtonState(GLOOST_MOUSE_BUTTON3, true);
//		}
//		else
//		{
//			getMouse()->setButtonState(GLOOST_MOUSE_BUTTON3, false);
//		}
//	}
}
