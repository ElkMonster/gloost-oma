  ...
  glPushAttrib(GL_ALL_ATTRIB_BITS);
  {
...

    {
      glPushMatrix();
      {
        ...
        gloost::drawWireRaster(grid1_subX, grid1_subY);

        gloost::drawWireRaster(grid2_subX, grid2_subY);

        glLineWidth(2.0);
        gloost::drawWireRaster(grid3_subX, grid3_subY);
      }
      glPopMatrix();
    }
...
Pad::onEnterFrame()
{
  ...
  {
    gloost::Mouse* mouse = _gui->getMouse();
