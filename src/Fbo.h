...
class Fbo
{
  ...
  public:
    ...
    void bind(unsigned int attachment = GL_COLOR_ATTACHMENT0_EXT);
...
/// 2010-03-23 thiesje: seems to be unused by current implementation
#ifdef CODE_COMMENTED_OUT
    unsigned int _width;
    unsigned int _height;

    GLuint       _depthHandle;
#endif // CODE_COMMENTED_OUT
