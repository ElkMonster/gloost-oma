...
#ifdef GLOOST_USE_DEPRECATED_GL_CALLS
...
#else
  gloostFrustum(_projection,  _left, _right, _bottom, _top, _nearPlaneZ, _farPlaneZ);
#endif
...
void ScreenCamera::updateFrustum()
{
  ...
  const float tan_term = tan(gloost::PI * _fov/180.0f);
