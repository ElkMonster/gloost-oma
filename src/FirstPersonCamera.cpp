...
FirstPersonCamera::move (const Vector3& speed)
{
  ...
  Vector3 directionalSpeed = _modelview.inverted() * speedHV;
...
FirstPersonCamera::rotateH (mathType speed)
{
  ...
  Vector3 curentUp = _modelview.inverted() * Vector3(0.0, 1.0, 0.0);
...
FirstPersonCamera::rotateV (mathType speed)
{
  ...
  Vector3 curentAxisX = _modelview.inverted() * Vector3(1.0, 0.0, 0.0);
